...
export default function ProfilePreviewPage() {
  ...
  const isOwnProfile = account?.id === params.accountId;
  const shownProfile = isOwnProfile && ownProfile ? { ...ownProfile, id: ownProfile.id, accountId: params.accountId } : profile;
  ...
  useEffect(() => {
    ...
    async function loadProfile() {
      ...
      try {
        const response = await fetch(`${apiBaseUrl}/users/${params.accountId}`, {
          cache: "no-store",
          headers: {
  ...
  }, [apiBaseUrl, getFreshAccessToken, isAuthenticated, isOwnProfile, params.accountId]);
